      ...
      <div className="grid lg:grid-cols-[1.15fr_1fr] gap-5">
        ...
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="panel p-5">
          <div className="flex items-center gap-2 text-[11px] font-mono uppercase tracking-[0.14em] text-muted-foreground">
            <MessagesSquare className="h-3.5 w-3.5 text-teal" /> Ask GreenGru
          </div>
          ...
          <div className="mt-4 flex items-center gap-2 rounded-lg border border-border bg-surface/50 px-3 py-2">
