...
import { Route as GraphRagRouteImport } from './routes/graph-rag'
...
const GraphRagRoute = GraphRagRouteImport.update({
  id: '/graph-rag',
  path: '/graph-rag',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/graph-rag': typeof GraphRagRoute
...
export interface RootRouteChildren {
  ...
  GraphRagRoute: typeof GraphRagRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/graph-rag': {
      ...
      path: '/graph-rag'
      fullPath: '/graph-rag'
      preLoaderRoute: typeof GraphRagRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/grant': {
      id: '/grant'
