...
import { A as CircleDot, B as ArrowRight, D as Factory, L as Banknote, M as CircleAlert, N as ChevronRight, R as BadgeCheck, T as FileText, b as Leaf, h as Maximize2, j as CircleCheck, o as Ship, p as Minimize2, t as Zap, u as Plus, z as ArrowUpRight } from "../_libs/lucide-react.mjs";
import { a as cn, i as PageHeader, n as CitationFooter, t as AppShell } from "./AppShell-DRknCBhl.mjs";
import { c as ratioSliders, i as factorySync, l as routeGrades, m as tierGauge, p as submissions, r as emissionsBreakdown, s as processMatrix } from "./dashboard-data-CiWeEW_G.mjs";
import { i as ResponsiveContainer, n as Pie, r as Cell, t as PieChart } from "../_libs/recharts+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CvPyuhKh.js
...
function Dashboard() {
	...
	const [factoryExpanded, setFactoryExpanded] = (0, import_react.useState)(false);
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHeader, {
				...
				right: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "h-4 w-4" }), " GreenGru Copilot"]
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					factoryExpanded && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "fixed inset-0 z-40 bg-black/70 backdrop-blur-sm",
						onClick: () => setFactoryExpanded(false)
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: cn("panel p-5 flex flex-col", factoryExpanded ? "fixed inset-6 z-50 shadow-2xl" : "relative"),
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: factoryExpanded ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Minimize2, { className: "h-3 w-3" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Maximize2, { className: "h-3 w-3" })
									})]
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: cn("mt-3", factoryExpanded && "flex-1 min-h-0"),
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ClientOnly, { fallback: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FactorySceneFallback, {}) })
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mt-3 pt-3 border-t border-border text-[11px] font-mono text-muted-foreground shrink-0",
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["First time? ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							...
							children: "Talk to GreenGru Copilot →"
						})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							to: "/new",
							className: "flex items-center gap-1 hover:text-foreground transition",
							children: ["Start a new submission ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "h-3 w-3" })]
						})]
					})
				]
			}),
