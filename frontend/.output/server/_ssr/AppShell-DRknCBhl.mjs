...
import { E as FileCheckCorner, F as Building2, L as Banknote, S as Gauge, _ as LogOut, b as Leaf, i as Upload, l as Radio, m as MessagesSquare } from "../_libs/lucide-react.mjs";
import { t as clsx } from "../_libs/clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/AppShell-DRknCBhl.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					}), it.children && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "relative mt-0.5 ml-[27px] space-y-0.5 border-l border-border pl-3",
						children: it.children.map((c) => {
							const cActive = pathname.startsWith(c.to);
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: c.to,
								className: cn("flex items-center gap-2 px-2 py-1.5 rounded-md text-[12.5px] transition-colors", cActive ? "bg-primary/10 text-foreground border border-primary/30" : "text-muted-foreground hover:text-foreground hover:bg-surface-2 border border-transparent"),
								children: [
