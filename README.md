...
2026 年起，欧盟 **CBAM** 进入实质计费。不会报**实际排放**的出口商，只能走 **IR (EU) 2025/2621 Annex I** 的**国家×税则号默认值**——对中国出口，热轧卷板（CN 7208）默认 SEE **3.187 tCO₂e/t**（2026 含 10% 加价 **3.506**），螺纹紧固件（CN 7318 15）为 **6.375**（→ **7.013**），均远高于免费配额基准 **1.370**（IR 2025/2620 路线 C），足以吞噬中小企业薄利。
...
flowchart TB
  subgraph PAIN["今天的断裂"]
    CBAM["CBAM 默认路径<br/>Annex I 高额默认 SEE"]
...
**1. 战略与资本市场** — 对标投资者与 **上交所 / 深交所 / 北交所** 碳披露；Cat.10 实数证明管住了最大气候影响（钢企巨头该类别可达数亿吨 CO₂e 量级）。

**2. 风险地图 → 减碳路径** — 点亮下游热点（如高炉可占约 2/3）、按 BF-BOF / EAF 指导产品与研发；**无 Cat.10 则无可信 SBTi Scope 3 目标**。

**3. 客户：商品 → 伙伴** — 从行业均值走向客户实数，联合减碳与绿品长约；链主成为低碳转型伙伴，而非纯卖钢。

> **绿毂一句话：** SME 跑完合规，链主一键收 **可验签 Scope 3**——满足三所与投资者，同时把客户做成减碳同盟。
...
一条核验数据，两边付费：中小企业为自身合规与融资就绪付费（SME SaaS/按次护照，人民币6,000元/年，或按次500元/份）；链主企业为自身范围三可见性与供应商分级付费（锚点企业席位，人民币50万元以上/年）。两条收入线独立存在、互相强化，硬件计量包为可选附加收入。
